...
import 'package:ilhewl/Helpers/import_export_playlist.dart';
import 'package:ilhewl/Helpers/playlist.dart';
import 'package:ilhewl/Helpers/search_add_playlist.dart';
import 'package:ilhewl/Helpers/webView.dart';
import 'package:ilhewl/Screens/Library/liked.dart';
import 'package:ilhewl/CustomWidgets/miniplayer.dart';
import 'package:ilhewl/APIs/spotifyApi.dart';
  ...
  if (data.isNotEmpty) {
                      ...
                      onTap: () async {
                        await TextInputDialog().showTextInputDialog(
                            ...
                            onSubmitted: (String value) async {
                              ...
                              final Map data = (await SpotifyApi().getTracksOfPlaylist(accessToken, value, 0)) as Map;
                              ...
                              Stream<Map> songsAdder() async* {
                                ...
                                for (int i = 0; i * 100 <= _total; i++) {
                                  final Map data = (await SpotifyApi().getTracksOfPlaylist(accessToken, value, i * 100)) as Map;
    ...
    if (index != null) {
      ...
      Stream<Map> songsAdder() async* {
        ...
        final List tracks = [];
        for (int i = 0; i * 100 <= _total; i++) {
          final Map data = (await SpotifyApi().getTracksOfPlaylist(accessToken, spotifyPlaylists[index]['id'].toString(), i * 100)) as Map;
