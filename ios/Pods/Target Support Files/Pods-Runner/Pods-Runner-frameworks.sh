...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/flutter_forbidshot/flutter_forbidshot.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/on_audio_query/on_audio_query.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/secure_application/secure_application.framework"
